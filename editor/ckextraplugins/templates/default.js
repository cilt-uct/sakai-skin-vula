...
CKEDITOR.addTemplates('customtemplates', {imagesPath: CKEDITOR.getUrl(CKEDITOR.basePath.substr(0, CKEDITOR.basePath.indexOf("ckeditor/"))+"../editor/ckextraplugins/" + 'templates/images/'), templates: [
    {
        ...
        html:'<style type="text/css">* .lessontitle {text-align:left; color: #005590; font-size:30px;}</style><h1 class="lessontitle"><span class="fa fa-file-text fa-fw"></span> Module X: Enter Title</h1></div>'
    },
    {
        ...
        html:'<style type="text/css">* .sectionheader {text-align:left; color: #005590;	padding-top: 10.0px;padding-bottom: 10.0px;background-color: rgb(250,250,250); }</style><h2 class="sectionheader"><span class="fa fa-file-text fa-fw"></span>Enter Section Title</h2></div>'
    },
    {
    ...
    },
    {
        ...
        html:'<div class="alert alert-info"><div style="float:left"><span class="fa fa-3x fa-lightbulb-o"></span></div> <div style="margin-left:35.0px"><strong>Enter a statement that highlights a key idea.</strong></div></div><div></div>'
    },
    {
        ...
        html:'<div class="panel panel-danger"> <div class="panel-heading"> <h3 class="callout-title"><span class="fa fa-exclamation-triangle"></span> Warning!</h3> </div>  <div class="panel-body">Use this to give your students a very noticeable warning. Don&#39;t overuse these, or your students will stop noticing them. </div> </div><div></div>'
    },
    {
        ...
        html:'<div class="alert alert-warning"> <div style="float:left"><span class="fa fa-star" style="font-size:26.0px"></span></div>  <div style="margin-left:35.0px"><strong>Replace this with appropriate text to alert your students about something important.</strong></div> </div><div></div>'
    },    
    {
